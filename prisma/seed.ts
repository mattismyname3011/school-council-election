  ...
  const teams = [
    {
      ...
      description: 'Experienced leadership team focused on academic excellence and student welfare',
    ...
    {
      name: 'Future Forward',
      description: 'Dynamic team committed to sustainability, athletics, and campus improvement',
